...
class ClashSquadOngoingFragment : Fragment() {
    ...
    private fun loadOngoingTournaments() {
        ...
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/ClashSquad.json?orderBy=\"Status\"&equalTo=\"Ongoing\""
        ...
        try {
            ...
            for ((key, value) in jsonObject.entrySet()) {
                ...
                val tournament = Tournament(
                    ...
                    SlotNumbers = getInt(obj, "SlotNumbers", 8),
    ...
    private fun startRealtimeCountListener(tournamentId: String, index: Int) {
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/ClashSquad/$tournamentId/JoinedPlayersCount.json"
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No ongoing Clash Squad tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): ClashSquadOngoingFragment {
            return ClashSquadOngoingFragment().apply {
