...
class BattleRoyalPastMatchesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_battle_royal_past_matches, container, false)
    ...
    private fun loadPastTournaments() {
        ...
        showLoading(true)
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/BattleRoyal.json?orderBy=\"Status\"&equalTo=\"Completed\"&limitToLast=2"
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No past tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): BattleRoyalPastMatchesFragment {
            return BattleRoyalPastMatchesFragment().apply {
