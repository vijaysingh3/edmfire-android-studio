...
class ClashSquadPastMatchesFragment : Fragment() {
    ...
    private fun loadPastTournaments() {
        ...
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/ClashSquad.json?orderBy=\"Status\"&equalTo=\"Completed\"&limitToLast=2"
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No past Clash Squad tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): ClashSquadPastMatchesFragment {
            return ClashSquadPastMatchesFragment().apply {
