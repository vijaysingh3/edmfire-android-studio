...
import com.edm.fire.databinding.ActivityClashSquadBinding
import com.google.android.material.tabs.TabLayoutMediator
import com.google.firebase.remoteconfig.FirebaseRemoteConfig
import com.google.firebase.remoteconfig.FirebaseRemoteConfigSettings

class ClashSquadActivity : AppCompatActivity() {

    private lateinit var binding: ActivityClashSquadBinding
    private lateinit var remoteConfig: FirebaseRemoteConfig

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityClashSquadBinding.inflate(layoutInflater)
    ...
    private fun setupViewPager(databaseUrl: String) {
        val adapter = ClashSquadViewPagerAdapter(this, databaseUrl)
