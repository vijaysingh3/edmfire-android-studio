...
class UpcomingMatchesAdapter(private val matchesList: List<UpcomingMatch>) :
    ...
    inner class UpcomingMatchViewHolder(itemView: View) :
        ...
        // ❌ REMOVED: tvPerKill - layout mein nahi hai, crash fix
    ...
    override fun onBindViewHolder(holder: UpcomingMatchViewHolder, position: Int) {
        ...
        holder.tvJoinStatus.text = "JOINED - ${match.status.uppercase()}"
        ...
        val hasActualRoomData = match.roomId != "Coming Soon...." && match.roomPassword != "Coming Soon...."
        ...
        // Room ID copy functionality — click karke clipboard me copy
