...
class LoneWolfOngoingFragment : Fragment() {
    ...
    private fun loadOngoingTournaments() {
        ...
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/LoneWolf.json?orderBy=\"Status\"&equalTo=\"Ongoing\""
    ...
    private fun startRealtimeCountListener(tournamentId: String, index: Int) {
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/LoneWolf/$tournamentId/JoinedPlayersCount.json"
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No ongoing Lone Wolf tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): LoneWolfOngoingFragment {
            return LoneWolfOngoingFragment().apply {
