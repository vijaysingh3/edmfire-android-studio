...
class BattleRoyalUpcomingFragment : Fragment() {
    ...
    private fun loadUpcomingTournaments() {
        ...
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/BattleRoyal.json?orderBy=\"Status\"&equalTo=\"Upcoming\""
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No upcoming tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): BattleRoyalUpcomingFragment {
            return BattleRoyalUpcomingFragment().apply {
