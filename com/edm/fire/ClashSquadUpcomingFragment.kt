...
class ClashSquadUpcomingFragment : Fragment() {
    ...
    private fun loadUpcomingTournaments() {
        ...
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/ClashSquad.json?orderBy=\"Status\"&equalTo=\"Upcoming\""
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No upcoming Clash Squad tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): ClashSquadUpcomingFragment {
            return ClashSquadUpcomingFragment().apply {
