...
class LoneWolfUpcomingFragment : Fragment() {
    ...
    private fun loadUpcomingTournaments() {
        ...
        val url = "$currentDatabaseUrl/Tournaments/TournamentMeta/LoneWolf.json?orderBy=\"Status\"&equalTo=\"Upcoming\""
    ...
    private fun getString(obj: JsonObject, key: String): String {
        return if (obj.has(key) && !obj.get(key).isJsonNull) obj.get(key).asString else ""
    }
    ...
    private fun updateUI() {
        if (tournamentList.isEmpty()) {
            tvEmptyMessage.text = "No upcoming Lone Wolf tournaments available"
    ...
    companion object {
        fun newInstance(databaseUrl: String): LoneWolfUpcomingFragment {
            return LoneWolfUpcomingFragment().apply {
